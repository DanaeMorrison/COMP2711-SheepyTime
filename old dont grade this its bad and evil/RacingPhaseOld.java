...
public class RacingPhaseOld {
    ...
    public RacingPhaseOld(ArrayList<Player> players, Deck deck, Nightmare nightmare, DreamTileBoard dreamTileBoard,
    ...
    public void startPhase() {
        ...
        while (!allPlayersAwake(players)) {
            for (int i = 0; i < playerCount; i++) {
                ...
                // If CardPlayer is instantiated outside of this class and passed to the
                // controller
                // then an indication is needed here to alert the controller to play the card
                // based
                // on that object outside the class, passing the picked card, the current
                // player, and
                 ...
                 * cardViewer = new CardViewer(curr.getHand().get(j), 1); //TODO: currently
                 * cardviewer can't actually change the card and nightmare type, should probably
                 * change
                 * cardViewer.rulePrint();
                 */
                // }

                // Scanner scanner = new Scanner(System.in); maybe move all this to a turnviewer
                // class?

                // System.out.println("Input which card you would like to use from your hand
                // (integer)");

                // TODO: here, the dreamtile is always being used if it can be used. we need to
                // ask the player if they want to use it or not.
                dreamTileUser(curr);
